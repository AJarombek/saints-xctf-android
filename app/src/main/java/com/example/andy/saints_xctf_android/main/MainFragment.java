package com.example.andy.saints_xctf_android.main;
...
import com.example.andy.saints_xctf_android.group.GroupDialogFragment;
import com.example.andy.saints_xctf_android.log.LogDialogFragment;
import com.example.andy.saints_xctf_android.log.LogRecyclerAdapter;
...
public class MainFragment extends Fragment {
    ...
    private ArrayList<com.example.andy.api_model.pojos.Log> logs;
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        com.example.andy.api_model.pojos.Log log = null;
        try {
    ...
    class LoadLogTask extends AsyncTask<String, Void, Object> {
        ...
        protected Object doInBackground(String... strings) {
            List<com.example.andy.api_model.pojos.Log> logs = null;
            try {
        ...
        protected void onPostExecute(Object response) {
            ...
            if (response != null) {
                if (response.equals("no_internet")) {
                    ...
                    ArrayList<com.example.andy.api_model.pojos.Log> addedlogs
                            = (ArrayList<com.example.andy.api_model.pojos.Log>) response;
