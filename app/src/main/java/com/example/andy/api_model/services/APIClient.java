...
import com.example.andy.api_model.pojos.Comment;
...
public class APIClient {
    ...
    public static List<com.example.andy.api_model.pojos.Log> logsGetRequest() throws IOException {
        String response = getRequest("https://www.saintsxctf.com/api/api.php/logs");
        if (response.equals("false")) return null;
        return JSONConverter.toLogList(response);
    }

    public static com.example.andy.api_model.pojos.Log logGetRequest(int logno) throws IOException {
    ...
    public static List<com.example.andy.api_model.pojos.Log> logfeedGetRequest(String... params)
            throws IOException {
    ...
    public static com.example.andy.api_model.pojos.Log logPostRequest(String log) throws IOException {
    ...
    public static com.example.andy.api_model.pojos.Log logPutRequest(int logno, String log)
            throws IOException {
